...
<el-tabs v-model="activeName">
            ...
            <div class="handle-box">
             <el-form ref="form" :model="form" label-width="60px">
                ...
                <el-form-item label="产品线" >
                    ...
                    <el-select v-model="n_value" value-key="business" filterable  clearable multiple placeholder="请选择节点" style="width:500px">
                        <el-option
                          v-for="item in nodes"
                          :key="item.tag_id"
                          :label="item.business"
                ...
                <el-form-item label="模板">
                    <el-select v-model="t_value"  @change="getChangedTemplate" filterable  clearable placeholder="请选择模板">
                        <el-option
    ...
    <el-tab-pane label="临时权限" name="second">
            <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 用户授权</el-breadcrumb-item>
        ...
        <div class="container">
            <div class="handle-box">
             <el-form ref="form" :model="form" label-width="60px">
                ...
                <el-form-item label="主机" >
                    <!-- <el-select v-model="n_value" @change="getChangedNode" filterable multiple clearable placeholder="请选择节点" style="width:500px"> -->
                    <el-select v-model="n1_value" value-key="hostname" filterable  clearable multiple placeholder="请选择主机" style="width:500px">
                        <el-option
                ...
                <el-form-item label="角色">
                    <el-select v-model="t1_value"  @change="getChangedTemplate" filterable  clearable placeholder="请选择角色">
                        <el-option
                ...
                <el-form-item label="用户">
                    <el-select v-model="u1_value" value-key="username"  multiple filterable clearable placeholder="请选择被授权用户">
                    <!-- <el-select v-model="u_value" @change="getChangedUser" multiple filterable clearable placeholder="请选择被授权用户"> -->
                        <el-option
                          v-for="item in users"
                          :key="item.id"
            ...
            <div class="but">
            <span slot="footer" class="dialog-footer">
                <el-button type="primary" @click="saveTempPriv">授 权</el-button>
            </span>
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            async getData() {
                ...
                // console.log("login:", this.$store.state.user.username)
                this.form.grantor = this.$store.state.user.username;
            ...
            saveAdd(){
                ...
                const form = {
                    ...
                    users: this.u_value,
                    template_id: this.t_template_id
                }
                this.privUser(form)
                this.getData()
            },
